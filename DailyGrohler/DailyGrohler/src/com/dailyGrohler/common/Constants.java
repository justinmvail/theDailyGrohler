...
//	public static final String PHONE_NUMBER = "13346695476@tmomail.net";//Me	
//	public static final String PHONE_NUMBER = "13253707434@vzwpix.com";//Mckay
//	public static final String PHONE_NUMBER = "12703146131@txt.att.net";//Moore
	public static final String PHONE_NUMBER = "13342960142@vzwpix.com";//Munoz
//	public static final String PHONE_NUMBER = "19312378366@vzwpix.com";//Dalton
	...
	public static final int DURATION_THREAD_SLEEP = 600000;
//	public static final int DURATION_THREAD_SLEEP = 1000;
	...
	public static final String[] EMAIL_MESSAGE_ARRAY = {"\"There's a big difference between falling in love with someone and falling in love with someone and getting married. Usually, after you get married, you fall in love with the person even more.\" - Dave Grohl",
														...
														"\"I swear I'll never give in, I refuse.\" - Dave Grohl",
														"\"I, I'm a streetlight shining.\" - Dave Grohl",
														"\"Is someone getting the best, the best, the best of you.\" - Dave Grohl"};
	public static final String[] PICTURE_NAMES = {PICTURE_PATH+"grohl1.jpg",
													PICTURE_PATH+"grohl2.jpg",
													PICTURE_PATH+"grohl3.jpg",
													PICTURE_PATH+"grohl4.jpg",
													PICTURE_PATH+"grohl5.jpg",
													PICTURE_PATH+"grohl6.jpg",
													PICTURE_PATH+"grohl7.jpg",
													PICTURE_PATH+"grohl8.jpg",
													PICTURE_PATH+"grohl9.jpg",
													PICTURE_PATH+"grohl10.jpg"};
